...
export const Route = createFileRoute("/about")({
  ...
  component: () => (
    <SimplePage eyebrow="Project" title="About Wallet" illustration={<AboutIllustration />}>
      <p>
        Wallet is an independent desktop wallet project built for
