...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://quick-stark.lovable.app/og-image.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "StarknetWallet — desktop wallet for Starknet" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://quick-stark.lovable.app/og-image.jpg" },
      { name: "twitter:image:alt", content: "StarknetWallet — desktop wallet for Starknet" },
      { name: "format-detection", content: "telephone=no" },
      { name: "apple-mobile-web-app-title", content: "StarknetWallet" },
      { name: "application-name", content: "StarknetWallet" },
    ],
    links: [
