...
const TITLE = "Cookies — Starknet Wallet";
const DESC = "Cookie usage on the Starknet Wallet website.";
...
function CookiesPage() {
  return (
    <SimplePage eyebrow="Legal" title="Cookies" illustration={<CookiesIllustration />}>
      ...
      <p>
        The Starknet Wallet desktop application itself does not use cookies —
